...
SMARTBUFF_DRUID = { };
SMARTBUFF_DRUID[1] = {"Mark of the Wild", 30, SMARTBUFF_CONST_GROUP, {1,10,20,30,40,50,60}, "WPET", "Gift of the Wild", 60, {50,60}};
...
-- Mage
SMARTBUFF_MAGE = { };
SMARTBUFF_MAGE[1] = {"Arcane Intellect", 30, SMARTBUFF_CONST_GROUP, {1,14,28,42,56}, "ROGUE;WARRIOR;HPET;WPET", "Arcane Brilliance", 60, {56}};
...
-- Priest
SMARTBUFF_PRIEST = { };
SMARTBUFF_PRIEST[1] = {"Power Word: Fortitude", 30, SMARTBUFF_CONST_GROUP, {1,12,24,36,48,60}, "WPET", "Prayer of Fortitude", 60, {48,60}};
SMARTBUFF_PRIEST[2] = {"Shadow Protection", 10, SMARTBUFF_CONST_GROUP, {30,42,56}, "WPET", "Prayer of Shadow Protection", 20, {56}};
SMARTBUFF_PRIEST[3] = {"Inner Fire", 10, SMARTBUFF_CONST_SELF};
SMARTBUFF_PRIEST[4] = {"Divine Spirit", 30, SMARTBUFF_CONST_GROUP, {40,42,54,60}, "ROGUE;WARRIOR;HPET;WPET", "Prayer of Spirit", 60, {60}};
...
SMARTBUFF_PALADIN[3]  = {"Blessing of Might", 5, SMARTBUFF_CONST_GROUP, {4,12,22,32,42,52,60}, "DRUID;MAGE;PRIEST;SHAMAN;WARLOCK;WPET", "Greater Blessing of Might", 15, {52,60} };
SMARTBUFF_PALADIN[4]  = {"Blessing of Wisdom", 5, SMARTBUFF_CONST_GROUP, {14,24,34,44,54,60}, "ROGUE;SHAMAN;WARRIOR;HPET;WPET", "Greater Blessing of Wisdom", 15, {54,60} };
SMARTBUFF_PALADIN[5]  = {"Blessing of Salvation", 5, SMARTBUFF_CONST_GROUP, {26}, "SHAMAN;WARRIOR;HPET;WPET", "Greater Blessing of Salvation", 15, {60} };
SMARTBUFF_PALADIN[6]  = {"Blessing of Kings", 5, SMARTBUFF_CONST_GROUP, {20}, "SHAMAN;WPET", "Greater Blessing of Kings", 15, {60} };
SMARTBUFF_PALADIN[7]  = {"Blessing of Sanctuary", 5, SMARTBUFF_CONST_GROUP, {30,40,50,60}, "DRUID;HUNTER;MAGE;PRIEST;ROGUE;SHAMAN;WARLOCK;HPET;WPET", "Greater Blessing of Sanctuary", 15, {60} };
SMARTBUFF_PALADIN[8]  = {"Blessing of Light", 5, SMARTBUFF_CONST_GROUP, {40,50,60}, "SHAMAN;WPET", "Greater Blessing of Light", 15, {60} };
